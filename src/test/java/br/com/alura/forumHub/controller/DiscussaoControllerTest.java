...
import br.com.alura.forumHub.curso.CursoRepo;
...
class DiscussaoControllerTest {
    ...
    void cadastrar_cenario2() throws Exception {
        ...
        when(usuarioRepo.getReferenceById(1L)).thenReturn(autor);
        when(cursoRepo.getReferenceById(1L)).thenReturn(curso);
        when(topicoRepo.save(any(Topico.class))).thenReturn(topico);
    ...
    void excluir_cenario1() throws Exception {
        ...
        when(topicoRepo.getReferenceById(1L)).thenReturn(topico);
